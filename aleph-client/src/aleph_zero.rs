...
pub mod api {
            ...
            impl StorageApi {
                ...
                > {
                    ::subxt::storage::address::StaticStorageAddress::new(
                        ...
                        vec![],
                        [
                            72u8, 208u8, 247u8, 106u8, 50u8, 146u8, 217u8, 109u8, 53u8, 20u8,
                            208u8, 188u8, 106u8, 74u8, 63u8, 57u8, 30u8, 142u8, 129u8, 121u8,
                            159u8, 254u8, 191u8, 40u8, 133u8, 118u8, 162u8, 178u8, 51u8, 247u8,
                            116u8, 23u8,
                        ],
                    )
                }
    ...
    pub fn validate_codegen<T: ::subxt::Config, C: ::subxt::client::OfflineClientT<T>>(
        ...
        if runtime_metadata_hash
            != [
                206u8, 99u8, 185u8, 126u8, 46u8, 81u8, 4u8, 157u8, 225u8, 225u8, 233u8, 74u8,
                134u8, 122u8, 233u8, 60u8, 127u8, 223u8, 176u8, 26u8, 200u8, 74u8, 150u8, 168u8,
                30u8, 121u8, 10u8, 38u8, 222u8, 16u8, 189u8, 28u8,
            ]
        {
